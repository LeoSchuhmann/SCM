...
@app.get('/risks')
def risks():
	hcm=pandas.read_excel("Flask/risks/HCM_risks.xlsx")
	pur=pandas.read_excel("Flask/risks/PUR_risks.xlsx")
	prod=pandas.read_excel("Flask/risks/PROD_risks.xlsx")

	return render_template('show_tables.html',  tables=[hcm.to_html(classes='data'), 
					      pur.to_html(classes='data'),
					      prod.to_html(classes='data')			  
						  ])
